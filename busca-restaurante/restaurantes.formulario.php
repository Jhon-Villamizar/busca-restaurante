...
<div class="container">
	...
	<div class="col-lg-6">
			...
			<div class="input-group mb-3">
			  ...
			  <input type="adreess" class="form-control" placeholder="Direccion" aria-label="text" autocomplete="off" aria-describedby="basic-addon1" name="direccion" id="direccion" required maxlength="60" value="<?php if (isset($detalle)) echo $detalle["direccion"]?>">
			</div>
			...
			<div class="input-group mb-3">
			  ...
			  <input type="web" class="form-control" placeholder="Pagina Web" aria-label="text" autocomplete="off" aria-describedby="basic-addon1" name="web" id="web" required maxlength="60" value="<?php if (isset($detalle)) echo $detalle["web"]?>">
			</div>
